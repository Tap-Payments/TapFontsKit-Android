...
public class FontPreferences extends ListPreference {
    ...
    public FontPreferences(final Context context, final AttributeSet attrs) {
        super(context, attrs);

        final TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.tap_FontListPreferences);
        final String fontDirectory = a.getString(R.styleable.tap_FontListPreferences_tap_fontDirectory);
        fontPreviewString = a.getString(R.styleable.tap_FontListPreferences_tap_fontPreviewString);
        a.recycle();
